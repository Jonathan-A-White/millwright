...
// For keeping two hosts level there are VaultFiles and TrackerSync, HostLock,
// which keeps two syncs on one host from running at once, and TrackerNotes,
// the read half of what the hosts leave each other in the tracker. Closing a
// story out reaches the world through Landing, which puts
